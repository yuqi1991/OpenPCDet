...
"""autogenerated by genpy from lidar_perception/CloudCluster.msg. Do not edit."""
import codecs
import sys
...
class CloudCluster(genpy.Message):
  _md5sum = "4c54633bc872ba468e139e500064a56b"
  _type = "lidar_perception/CloudCluster"
...
float32 y
float32 z"""
  __slots__ = ['header','id','label','score','cloud','min_point','max_point','avg_point','nearest_point','centroid_point','estimated_angle','dimensions','eigen_values','eigen_vectors','fpfh_descriptor','bounding_box','convex_hull']
  _slot_types = ['std_msgs/Header','uint32','string','float64','sensor_msgs/PointCloud2','geometry_msgs/PointStamped','geometry_msgs/PointStamped','geometry_msgs/PointStamped','geometry_msgs/PointStamped','geometry_msgs/PointStamped','float64','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Vector3[]','std_msgs/Float32MultiArray','jsk_recognition_msgs/BoundingBox','geometry_msgs/PolygonStamped']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,id,label,score,cloud,min_point,max_point,avg_point,nearest_point,centroid_point,estimated_angle,dimensions,eigen_values,eigen_vectors,fpfh_descriptor,bounding_box,convex_hull
    ...
    if args or kwds:
      ...
      if self.nearest_point is None:
        self.nearest_point = geometry_msgs.msg.PointStamped()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3d3I().pack(_x.avg_point.point.x, _x.avg_point.point.y, _x.avg_point.point.z, _x.nearest_point.header.seq, _x.nearest_point.header.stamp.secs, _x.nearest_point.header.stamp.nsecs))
      _x = self.nearest_point.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3d3I().pack(_x.nearest_point.point.x, _x.nearest_point.point.y, _x.nearest_point.point.z, _x.centroid_point.header.seq, _x.centroid_point.header.stamp.secs, _x.centroid_point.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.avg_point.point.x, _x.avg_point.point.y, _x.avg_point.point.z, _x.nearest_point.header.seq, _x.nearest_point.header.stamp.secs, _x.nearest_point.header.stamp.nsecs,) = _get_struct_3d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.nearest_point.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.nearest_point.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 36
      (_x.nearest_point.point.x, _x.nearest_point.point.y, _x.nearest_point.point.z, _x.centroid_point.header.seq, _x.centroid_point.header.stamp.secs, _x.centroid_point.header.stamp.nsecs,) = _get_struct_3d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end

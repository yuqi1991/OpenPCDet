...
def simplify_postprocess(onnx_model):
    ...
    cls_preds = gs.Variable(name="cls_preds", dtype=np.float32, shape=(1, 248, 216, 72))
    box_preds = gs.Variable(name="box_preds", dtype=np.float32, shape=(1, 248, 216, 84))
    dir_cls_preds = gs.Variable(name="dir_cls_preds", dtype=np.float32, shape=(1, 248, 216, 24))
